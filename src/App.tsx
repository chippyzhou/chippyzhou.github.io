    ...
    <div className="grid gap-4 md:grid-cols-[0.8fr_1.2fr] md:items-end">
      <div>
        <p
          className={`text-sm font-semibold uppercase tracking-[0.18em] ${
            inverted ? "text-[#83d7ce]" : "text-[#0e7c75]"
          }`}
        >
          {kicker}
        </p>
      ...
      <p
        className={`max-w-2xl text-base leading-7 md:justify-self-end ${
          inverted ? "text-white/68" : "text-black/62"
        }`}
      >
        {description}
      </p>
    ...
    <main className="min-h-screen bg-[#f6f7f4] text-[#151515]">
      <header className="sticky top-0 z-20 border-b border-black/10 bg-[#f6f7f4]/92 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <a href="#top" className="text-sm font-semibold tracking-[0.16em]">
            {profile.name}
          </a>
          ...
          <a
            ...
            className="rounded-[8px] bg-[#151515] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#0e7c75]"
          >
            Contact
          </a>
        </nav>
      ...
      <section
        id="top"
        className="mx-auto grid max-w-6xl gap-10 px-5 py-12 md:grid-cols-[1.05fr_0.95fr] md:items-center md:py-20"
      >
        <div className="space-y-8">
          ...
          <dl className="grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4">
            {metrics.map((item) => (
              <div
                key={item.label}
                className="border-l border-black/18 py-2 pl-4"
              >
      ...
      <section
        id="about"
        className="border-y border-black/10 bg-white px-5 py-16"
      >
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[0.85fr_1.15fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#b2542f]">
              About
            </p>
            <h2 className="mt-3 text-3xl font-semibold">Personal profile</h2>
          </div>
      ...
      <section
        id="publications"
        className="border-y border-black/10 bg-[#151515] px-5 py-16 text-white"
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 divide-y divide-white/14 rounded-[8px] border border-white/14">
      ...
      <section id="awards" className="mx-auto max-w-6xl px-5 py-16">
        <SectionHeading
          kicker="Awards"
        ...
        <div className="mt-8 grid gap-4">
          {awards.map((award) => (
            ...
            >
              <p className="text-lg font-semibold text-[#0e7c75]">
                {award.year}
              </p>
              <div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {gallery.map((item) => (
              <figure
                key={item.title}
                className="overflow-hidden rounded-[8px] border border-black/10 bg-[#f6f7f4]"
              >
                <img
                  src={item.src}
                  alt={item.title}
